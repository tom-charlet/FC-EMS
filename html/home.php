    ...
    <header>
        ...
        <nav class="header-nav no-scroll-bar">
            <ul>
                ...
                <li>
                    <a href="private/convocations.html">
                        <div class="bloc-icon">
                            <svg width="16" height="16" viewBox="0 0 16 16" fill="none"
                                xmlns="http://www.w3.org/2000/svg">
                                <path
                ...
                <li class="dropdown-menu">
                    ...
                    <ul>
                        <li><a href="private/histoire.html">Histoire</a></li>
                        <li><a href="#">Palmarès</a></li>
                        <li><a href="private/organigramme.html">Organigramme</a></li>
                    </ul>
                    <span class="split-bar"></span>
                </li>
                ...
                <li class="dropdown-menu">
                    ...
                    <ul>
                        <li><a href="private/galerie.html">photos</a></li>
                        <li><a href="private/galerie.html">vidéos</a></li>
                    </ul>
                    <span class="split-bar"></span>
                </li>
            ...
            <div class="actu-container">
                ...
                <div class="actu-club-container">
                    ...
                    <article class="actu-club-article">
                        <a class="actu-club-link" href="private/article-full.html">
                            <div class="actu-club-items">
                                <img class="actu-club-items-img img-cover" src="img/img-test-foot.jpg"
                                    alt="actualité club">
                                <h3 class="actu-club-items-title">Lorem ipsum dolor sit amet consectetur.</h3>
                            </div>
                        </a>
                    </article>
                    ...
                    <article class="actu-club-article">
                        <a class="actu-club-link" href="private/article-slider.html">
                            <div class="actu-club-items">
                                <img class="actu-club-items-img img-cover" src="img/img-test-foot.jpg"
                                    alt="actualité club">
                                <h3 class="actu-club-items-title">Lorem ipsum dolor sit amet consectetur.</h3>
                    ...
                    <div class="res-content">
                        ...
                        <article class="res-article">
                            <div class="res-article-score">
                                ...
                                <div class="logo-team-m">
                                    <img class="img-contain" src="img/logo-ems.png" alt="logo de l'équipe 1">
                                </div>
                                <h4 class="res-match">3 - 2</h4>
                                <div class="logo-team-m">
                                    <img class="img-contain" src="img/logo-ems.png" alt="logo de l'équipe 1">
                                </div>
                            ...
                            <div class="res-article-info">
                                <p>MATCHS AMICAUX - 3 DECEMBRE 2021 - 15H50 - PAUL COUDRET</p>
                            </div>
                        </article>
                        <article class="res-article">
                            <div class="res-article-score">
                                <h3 class="team-name">FC EMS</h3>
                                <div class="logo-team-m">
                                    <img class="img-contain" src="img/logo-ems.png" alt="logo de l'équipe 1">
                                </div>
                                <h4 class="res-match">3 - 2</h4>
            ...
            <div class="galerie-header">
                ...
                <div class="galerie-photo-container">
                    <div class="galerie-photo-items">
                        ...
                        <img class="img-cover" src="../img/img-test-foot.jpg" alt="photo du club">
                    </div>
                    <div class="galerie-photo-items">
                        <svg version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
                            x="0px" y="0px" viewBox="0 0 100 100" style="enable-background:new 0 0 100 100;"
